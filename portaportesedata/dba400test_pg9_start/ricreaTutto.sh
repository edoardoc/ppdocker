...
rm -rf /home/dba400/*
docker run -d -v /root:/pginput -v /home/dba400:/pg/data --name pp24.prv.lan -i -t -p 5432:5432 -e POSTGRES_PASSWORD=password portaportese/dba400 


# cmd da lanciare da altra shell
#docker exec -i -t pp24.prv.lan su - postgres -c "pg_restore -v -d dba400L1 -Fc /pginput/dba400dump_20160406-1217 -U pepper | psql template1"
