...
(function($, window, document, undefined)
{
    $.fn.lazy = function(settings)
    {
        ...
        if( configuration.bind == "load" ) _init();
        ...
        function _isInLoadableArea(element)
        {
			...
			var result=(top + _getActualHeight() + configuration.threshold) > (element.offset().top + element.height());
			
			//console.log("loadableArea:"+result)
            return result;
        }
