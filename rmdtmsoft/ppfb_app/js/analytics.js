var GA_uuid = navigator.userAgent ;
var GA_appName = "PP Mobile" ;
var GA_UA = "UA-866200-6" ; // Default 
...
(function () {
    ...
    function va(a) {
        var b = M[B],
            b = b[E] + "//" + b[x];
        return a || 0 != M[ka][t](b) ? M[ka] : void 0
    }
    ...
    var oc = function () {
        ...
        xc = function (a, b) {
            ...
            else if (d = O.XMLHttpRequest) d = new d, "withCredentials" in d && (c = d, c.open("POST", oc() + "/collect", !0), c.setRequestHeader("Content-Type", "text/plain"));
    ...
    function X(a, b, c, d) {
        b[a] = function () {
            try {
                ...
                var g = b && b[v];
                if (!(1 <= 100 * n.random())) {
                    var ca = ["t=error", "_e=exc", "_v=j11", "sr=1"];
                    a && ca[p]("_f=" + a);
        ...
        mc = function (a) {
            if ("cookie" == P(a, ac)) {
                var b = P(a, U),
                    c;
                c = P(a, Q);
                c = sa(c).replace(/\(/g, "%28").replace(/\)/g, "%29");
                var d = ic(P(a, W)),
                    e = jc(P(a, Yb));
                1 < e && (d += "-" + e);
                c = ["GA1", d, c][H](".");
            ...
            if (a.get(Wc)) {
                var b = P(a, W),
                    c = P(a, $b) || eb(),
                    d = Xc("__utma", c, b);
                d && (J(19), a.set(Tc, (new Date)[da](), !0), a.set(Rc, d.R), (b = Xc("__utmz", c, b)) && d[h] == b[h] &&
                    a.set(Sc, b.R))
            }
        }, Gc = function (a, b, c) {
        ...
        Jc = function (a, b) {
            ...
            if (!a.get(Q))
                if (c = (c = O.gaGlobal && O.gaGlobal.vid) && -1 != c[ga](/^(?:utma\.)?\d+\.\d+$/) ? c : void 0) J(17), a[q].set(Q, c);
                    ...
                    c = O[oa];
                    c = c.appName +
                        c.version + c.platform + c.userAgent + (M[r] ? M[r] : "") + (M[ka] ? M[ka] : "");
                    d = c[y];
