;(function() {
    ...
    FacebookInAppBrowser = {
        ...
        login: function(data) {
            ...
            authorize_url += "&response_type="+this.settings.response_type;
        ...
        getInfo: function(afterCallback) {
            ...
            var get_url  = "https://graph.facebook.com/me?fields=email,name,last_name,id,gender&access_token=" + window.localStorage.getItem('facebookAccessToken');
